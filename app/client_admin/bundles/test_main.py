...
class TestMain(ITestMain,YCappuccino):
    ...
    def display(self):
        ...
        w_html = '<button class="button" id="test1" type="submit" onclick="on_click(\''+self.id()+'\',\'activate_test_1\')">Test1</button>'
        w_html = w_html+'<button class="button" id="test2" type="submit" onclick="on_click(\''+self.id()+'\',\'activate_test_2\')">Test2</button>'
