...
if __name__ == "__main__":
    ...
    parser.add_argument('--port', default=9000, type=int, help='http port of the application')

    args = parser.parse_args()

    ycappuccino.core.init(root_path=args.root_path, app="yblues,ycappuccino*", port=args.port)
    # Run the server
